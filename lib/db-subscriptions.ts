...
export async function getSubscriptionPlans(
  ...
  let query = db
    ...
    .select('id, name, description, cohort_id, status, archived_at, created_by, created_at, updated_at, subscription_plan_prices(id, duration_months, amount, currency, is_active, sort_order), subscription_plan_content(id, content_table, content_id)')
    .order('name');
